...
#ifndef RUN_STANDALONE_MOTOR_TUNER
#define RUN_STANDALONE_MOTOR_TUNER 0
#endif
...
#if RUN_STANDALONE_MOTOR_TUNER
    xTaskCreate(motor_tuner_task, "motor_tuner", 4096, NULL, tskIDLE_PRIORITY + 3, NULL);
#else
