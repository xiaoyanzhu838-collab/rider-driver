...
#define BOARD_WHEEL_BREAKAWAY_SPEED (90)
#define BOARD_WHEEL_BREAKAWAY_HIGH_SPEED (130)
...
#define BOARD_BALANCE_SERIAL_LOG_ENABLE (0)
...
#define BOARD_BALANCE_ZERO_CAPTURE_PITCH_DEG (3.0f)
#define BOARD_BALANCE_ZERO_CAPTURE_RATE_DPS (1.0f)
#define BOARD_BALANCE_ZERO_CAPTURE_HOLD_MS (500)
#define BOARD_BALANCE_ZERO_CAPTURE_SPAN_DEG (1.0f)
#define BOARD_BALANCE_ZERO_CAPTURE_LIMIT_DEG (2.5f)
#define BOARD_BALANCE_PITCH_DEADBAND_DEG (0.1f)
#define BOARD_BALANCE_RATE_DEADBAND_DPS (0.5f)
#define BOARD_BALANCE_WHEEL_FEEDBACK_INTERVAL_MS (20)
#define BOARD_BALANCE_THETA_COMPLEMENTARY_ALPHA (0.96f)
#define BOARD_BALANCE_RATE_LPF_ALPHA (0.5f)
#define BOARD_BALANCE_STICTION_PITCH_DEG (1.0f)
#define BOARD_BALANCE_STICTION_HIGH_PITCH_DEG (4.0f)
#define BOARD_BALANCE_STICTION_SPEED_THRESHOLD (2.0f)
#define BOARD_BALANCE_STICTION_BOOST_MS (120)
...
#define BOARD_BALANCE_KP           (7.0f)
#define BOARD_BALANCE_KI           (0.0f)
#define BOARD_BALANCE_KD           (0.5f)
#define BOARD_BALANCE_I_TERM_LIMIT (30.0f)
#define BOARD_BALANCE_D_TERM_LIMIT (70.0f)
#define BOARD_BALANCE_KW           (0.45f)
...
#define BOARD_WHEEL_PROBE_RUN_MS       (2500)
#define BOARD_WHEEL_PROBE_BRAKE_MS     (1500)
#define BOARD_WHEEL_PROBE_SPEED_POS    (60)
#define BOARD_WHEEL_PROBE_SPEED_NEG    (-60)
