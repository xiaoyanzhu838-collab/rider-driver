...
#define BOARD_IMU_DIAGNOSTIC_MODE  (1)
...
#define BOARD_BALANCE_ARM_PITCH_DEG (12.0f)
#define BOARD_BALANCE_ARM_GYRO_DPS (15.0f)
#define BOARD_BALANCE_ARM_HOLD_MS (250)
...
#define BOARD_BALANCE_KP           (4.2f)
#define BOARD_BALANCE_KD           (1.0f)
#define BOARD_BALANCE_D_TERM_LIMIT (45.0f)
#define BOARD_BALANCE_KW           (0.65f)
